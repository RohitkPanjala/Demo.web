...
<body>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="p10.jpg" alt="First slide">
      <div class="carousel-caption d-none d-md-block">
        
      </div>
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="p11.jpg" alt="Second slide">
      <div class="carousel-caption d-none d-md-block">
        ...
        <div class="col-lg-12">
            ...
            <table class="table">
                ...
                <tr >
                    ...
                    <td class="text-center"><a href="book.php?id=<?php echo $res['hotel_id'];?>" class="btn btn-primary">Book</a></td>
                </tr>
